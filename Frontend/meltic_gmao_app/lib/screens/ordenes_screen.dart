...
class _OrdenesScreenState extends State<OrdenesScreen> {
    ...
    if (ot.reportePdfBase64 != null) {
      ...
      if (ot.checklists != null && ot.checklists!.isNotEmpty) {
        try {
          ...
          debugPrint('OrdenesScreen: error al parsear checklists JSON: $e');
        }
      }
  ...
  String _formatDate(String dt) {
    try {
      ...
      debugPrint('OrdenesScreen._formatDate error: $e');
      return dt;
    }
  }
}
...
class _CrearOTDialogState extends State<_CrearOTDialog> {
  ...
  Future<void> _cargarDatos() async {
    try {
      ...
      debugPrint('OrdenesScreen._cargarDatos error: $e');
    }
  }
  ...
  Future<void> _guardar() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Error al guardar la OT: $e'),
            backgroundColor: IndustrialTheme.criticalRed,
          ),
        );
      }
