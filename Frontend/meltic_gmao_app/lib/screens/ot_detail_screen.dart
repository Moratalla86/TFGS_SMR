...
class _OTDetailScreenState extends State<OTDetailScreen> {
  ...
  void initState() {
    ...
    if (_ot.checklists != null && _ot.checklists!.isNotEmpty) {
      try {
        ...
        debugPrint('OTDetailScreen: error al parsear checklists JSON: $e');
      }
  ...
  Future<void> _cargarTecnicos() async {
    if (_session.isJefe && _ot.estado == 'SOLICITADA') {
      try {
        ...
        debugPrint('OTDetailScreen: error cargando técnicos: $e');
      }
    }
  }
  ...
  Future<String?> _capturarFirma(
    ...
    try {
      ...
      debugPrint('OTDetailScreen: error capturando imagen de firma: $e');
      return null;
    }
  }
  ...
  String _formatDate(String dt) {
    try {
      ...
      debugPrint('OTDetailScreen._formatDate error: $e');
      return dt;
    }
  }
}
